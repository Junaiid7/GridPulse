...
class OpenMeteoClient:
    ...
    def __init__(self, *, http: Optional[HttpClient] = None, logger: Optional[logging.Logger] = None) -> None:
    ...
    @staticmethod
    def _windows(start_date: date, end_date: date, chunk_days: Optional[int]) -> list[tuple[date, date]]:
